...
class PriceCreateTest(AssertStripeFksMixin, TestCase):
    ...
    def test_create_from_product_id(self, price_create_mock, product_retrieve_mock):
        ...
        self.assertIsInstance(fake_price["product"], str)
    ...
    def test_create_from_stripe_product(self, price_create_mock, product_retrieve_mock):
        ...
        fake_price["unit_amount"] /= 100
        self.assertIsInstance(fake_price["product"], dict)
    ...
    def test_create_from_djstripe_product(
        ...
        fake_price["unit_amount"] /= 100
        self.assertIsInstance(fake_price["product"], Product)
...
class PriceTest(AssertStripeFksMixin, TestCase):
    ...
    def test_str(self):
        self.assertEqual(str(self.price), self.price_data["nickname"])
    ...
    def test_stripe_price(self, price_retrieve_mock):
        ...
        self.assertEqual(price.amount_in_cents, price.unit_amount / 100)
        self.assertIsInstance(price.amount_in_cents, float)
    ...
    def test_stripe_tier_price(self, price_retrieve_mock):
        ...
        self.assertIsNone(price.unit_amount)
        self.assertIsNotNone(price.tiers)
    ...
    def test_stripe_metered_price(self, price_retrieve_mock):
        ...
        price = Price.sync_from_stripe_data(price_data)
        self.assertEqual(price.id, price_data["id"])
        self.assertEqual(price.recurring["usage_type"], PriceUsageType.metered)
...
class HumanReadablePriceTest(TestCase):
    ...
    def test_human_readable_one_time(self):
        ...
        self.assertEqual(price.human_readable_price, "$20.00 USD (one time)")
    ...
    def test_human_readable_free_usd_daily(self):
        ...
        self.assertEqual(price.human_readable_price, "$0.00 USD/day")
    ...
    def test_human_readable_10_usd_weekly(self):
        ...
        self.assertEqual(price.human_readable_price, "$10.00 USD/week")
    ...
    def test_human_readable_10_usd_2weeks(self):
        ...
        self.assertEqual(price.human_readable_price, "$10.00 USD every 2 weeks")
    ...
    def test_human_readable_499_usd_monthly(self):
        ...
        self.assertEqual(price.human_readable_price, "$4.99 USD/month")
    ...
    def test_human_readable_25_usd_6months(self):
        ...
        self.assertEqual(price.human_readable_price, "$25.00 USD every 6 months")
    ...
    def test_human_readable_10_usd_yearly(self):
        ...
        self.assertEqual(price.human_readable_price, "$10.00 USD/year")
